...
public class GubanovFiles{
    ...
    public func getTgAvatars() async throws -> Any {
        return try await fetchJSON(from: "\(api)/tg-avatars")
    }

    public func getProjectMentions() async throws -> Any {
        return try await fetchJSON(from: "\(api)/mentions")
    }
}
